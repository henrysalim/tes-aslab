            ...
            <div ref={divRef} style={{
                ...
                <div className="flex justify-center">
                    <p className="w-full md:w-1/2 mt-16 text-center">
                        Di <span className="font-bold">CreatixStudio</span>, kami menawarkan rangkaian layanan kreatif
                        yang
                        komprehensif, dirancang untuk
                        membantu
                        merealisasikan setiap aspek visi kreatif Anda. Berikut adalah gambaran lebih lanjut tentang
                        layanan
                ...
                <div className="flex flex-col lg:flex-row justify-center gap-3 md:gap-8 lg:gap-16 mt-10">
                    ...
                    <div className="w-full lg:w-1/3">
                        ...
                        <p className="text-justify">Dengan teknologi animasi terdepan dan tim kreatif
                            ...
                            layanan animasi yang meliputi animasi 2D, 3D, motion graphics, dan animasi eksplainer.
                            Setiap
                            frame yang kami buat dipersiapkan dengan perhatian terhadap detail yang ketat, memastikan
                            bahwa
                            setiap proyek memberikan dampak visual yang maksimal dan menyampaikan pesan Anda dengan
                            efektif.
                        </p>
                    </div>
                </div>
                <div className="flex flex-col-reverse lg:flex-row justify-center gap-3 md:gap-8 lg:gap-16 mt-10">
                    <div className="w-full lg:w-1/3">
                        ...
                        <p className="text-justify">Tim pengembang game kami mengkombinasikan seni
                            ...
                            aplikasi edukasi interaktif, kami menawarkan solusi game yang tidak hanya menghibur tetapi
                            juga
                ...
                <div className="flex flex-col lg:flex-row justify-center gap-3 md:gap-8 lg:gap-16 mt-10">
                    ...
                    <div className="w-full lg:w-1/3">
                        ...
                        <p className="text-justify">
                            Apakah Anda membutuhkan video korporat, iklan, atau konten media sosial, tim produksi video
                            kami
                            memiliki keahlian untuk menghasilkan video berkualitas tinggi yang beresonansi dengan
                            audiens
                            Anda. Kami menggabungkan narasi visual yang menarik dengan editing dan post-produksi yang
                            cermat
                            untuk memastikan setiap video tidak hanya terlihat profesional tetapi juga memiliki dampak
                            yang
                            kuat.
                        </p>
                    </div>
                ...
                <div className="flex justify-center">
                    <p className="w-full md:w-1/2 mt-16 text-center italic">
                        Di <span className="font-bold">CreatixStudio</span>, setiap proyek dianggap sebagai sebuah
                        kesempatan untuk inovasi dan keunggulan
                        kreatif. Kami bangga dapat bekerja erat dengan klien kami untuk menghasilkan hasil yang tidak
                        hanya
