    ...
    return (
        <MainLayout>
            <div ref={divRef} style={{
                ...
                <div className="mt-16">
                    <img loading="lazy" src="./images/hero-aboutus.jpg" alt="CreatixStudio"
                         className="object-cover rounded w-full h-96"/>
                    <p className="mt-4 text-center"><span className="font-bold">CreatixStudio</span> didirikan dengan
                        visi
                        untuk mendorong batas-batas
                        kreativitas dan inovasi dalam dunia
                        digital. Sejak awal, kami telah berkomitmen untuk menyajikan hasil karya yang tidak hanya
                        menarik
                        secara
                        estetika, tetapi juga efektif dalam menyampaikan pesan dan nilai klien kami. Dengan tim yang
                        terdiri
                ...
                <div className="mt-32 bg-primary text-gray-200 rounded-md p-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        <div>
                            ...
                            <p className="text-center lg:text-justify mt-3">
                                ...
                                sesuatu
                                yang luar biasa. Kunci dari keberhasilan kami adalah pendekatan kolaboratif kami, di
                                mana
                                kami
                        ...
                        <div>
                            ...
                            <p className="text-center lg:text-justify mt-3">
                                ...
                                solusi kreatif yang efektif. Projek-projek kami telah diakui dan dipuji baik dalam
                                lingkup
                    ...
                    <div>
                        ...
                        <p className="mt-3 text-center">
                            ...
                            memperluas jasa kami untuk mencakup teknologi terbaru dalam AI dan virtual reality, dan
                            terus
